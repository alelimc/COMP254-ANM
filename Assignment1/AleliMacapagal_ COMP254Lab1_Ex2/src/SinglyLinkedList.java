...
public class SinglyLinkedList<E> {
    ...
    public void addLast(E e) {                 // adds element e to the end of the list
        ...
        if (isEmpty())
            ...
            tail.setNext(newest);                  // new node after existing tail ***will not matter if these 2 are interchanged
    ...
    public void swapNodes(String n1, String n2){
        ...
        //iterates through the list to find nodes with values n1 and n2
        //Search for node1
        while(node1 != null && node1.element != n1){
            prevNode1 = node1;
            node1 = node1.next;
        }

        //Search for node2
        while(node2 != null && node2.element != n2){
            prevNode2 = node2;
            node2 = node2.next;
        }

        // If both nodes are found, it swaps the connections of the nodes by adjusting the next pointers
        // and the next pointers of their previous nodes accordingly.
    ...
    public static void main(String[] args)
    {
        ...
        //Swap the nodes
        System.out.println("-------------- Swap the nodes --------------");
        sList.swapNodes("LAX","YYZ");
        System.out.println("List after swapping nodes LAX, YYZ: ");
        sList.display();

        sList.swapNodes("LAX","TPE");
        System.out.println("List after swapping nodes LAX, TPE: ");
        sList.display();
